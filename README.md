...
2. Copy the following to the page you have chosen:
  ...
  ```javascript
  // [[File:User:He7d3r/Tools/InternalLinkSuggestions.js]] (workaround for [[bugzilla:33355]])
  mw.loader.load( '//meta.wikimedia.org/w/index.php?title=User:He7d3r/Tools/InternalLinkSuggestions.js&action=raw&ctype=text/javascript' );
  ```
